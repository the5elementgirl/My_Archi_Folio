  ...
  return (
    <section className="dark:bg-gray-900 pb-20 transition-colors duration-500">
      <div className="max-w-6xl mx-auto h-48 dark:bg-ink antialiased">
        <h1 className="text-5xl md:text-9xl py-20 font-bold text-center md:text-left text-ink dark:bg-gray-900 dark:text-paper">
          Contact
        </h1>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="md:ml-4">
            ...
            <div className="icons-container inline-flex flex-col my-10 space-y-4">
              {/* Email */}
              <div className="flex flex-row items-center space-x-6 p-4 border border-transparent hover:border-brass transition-all duration-300 rounded-md">
